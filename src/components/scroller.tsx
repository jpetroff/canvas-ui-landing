...
const Scroller : React.FC<TScroller> = (
  ...
  <ScrollArea.Root className="flex flex-col flex-grow w-full overflow-hidden" type="auto">
    ...
    >
      <ScrollArea.Thumb className="flex-1 bg-zinc-950 rounded-full relative before:content-[''] before:absolute before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 before:w-full before:h-full before:min-w-[44px] before:min-h-[44px]" />
    </ScrollArea.Scrollbar>
  </ScrollArea.Root>
);
