...
const SvgKoFiLogo = (props) => /* @__PURE__ */ React.createElement("svg", { width: 43, height: 42, viewBox: "0 0 43 42", fill: "none", xmlns: "http://www.w3.org/2000/svg", ...props }, /* @__PURE__ */ React.createElement("g", { clipPath: "url(#clip0_61_19938)" }, /* @__PURE__ */ React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M21.5 42C33.098 42 42.5 32.598 42.5 21C42.5 9.40202 33.098 0 21.5 0C9.90202 0 0.5 9.40202 0.5 21C0.5 32.598 9.90202 42 21.5 42ZM37.4643 18.5716V18.5724H37.4648C37.8999 20.7882 37.3917 22.8769 36.0341 24.4546C35.3428 25.2579 34.4685 25.8882 33.4359 26.3283C32.4557 26.7459 31.38 26.9718 30.2362 27.0008C30.1797 27.695 30.0353 28.2916 29.7965 28.821C29.2913 29.9411 28.4028 30.6705 27.156 30.9894L27.1457 30.9919C26.8459 31.0641 26.6209 31.0641 26.383 31.0641C22.2848 31.116 13.9237 31.1164 13.57 31.1164H13.5666L13.5654 31.1164C13.5169 31.1159 12.7277 31.1071 11.9217 30.7162C11.1333 30.3338 10.1722 29.5213 10.0672 27.8216C10.0663 27.8129 10.0659 27.8038 10.0659 27.7951C9.96333 23.4277 10.0104 15.377 10.0131 14.9237L10.0132 14.9044V14.6885C10.0132 13.9806 10.5803 13 11.6444 13L30.5679 13.0008C32.0563 13.0008 33.5227 13.4538 34.6972 14.2758C35.6999 14.931 36.9927 16.2068 37.4627 18.5625L37.4635 18.5675L37.4643 18.5716ZM11.4057 14.9085C11.4036 15.2531 11.355 23.3548 11.4576 27.7486V27.7473C11.5111 28.5665 11.8719 29.1431 12.5287 29.462C13.0452 29.7123 13.5625 29.7223 13.5675 29.7223H13.6426C15.7093 29.7215 22.734 29.7161 26.3701 29.67H26.3838C26.581 29.67 26.6803 29.67 26.8173 29.6372C28.1977 29.2826 28.8707 28.1899 28.8707 26.2971C28.8707 26.1082 28.9492 25.9247 29.0858 25.7939C29.2228 25.6632 29.4096 25.593 29.5985 25.6017C31.8076 25.7014 33.7681 24.9516 34.9779 23.5454C36.0515 22.2978 36.4492 20.6255 36.0968 18.8369C35.7949 17.3207 35.0647 16.1765 33.9267 15.4362L33.9143 15.428L33.9059 15.4221C32.9622 14.7587 31.7765 14.3933 30.5675 14.3933L11.644 14.3925C11.458 14.3925 11.4086 14.6727 11.4057 14.6922V14.9085ZM29.5798 23.7929C29.6043 23.7946 29.8301 23.8095 30.183 23.8095C30.6397 23.8095 31.0898 23.785 31.5211 23.7373C31.5664 23.7323 31.6116 23.7227 31.6552 23.709C33.4724 23.132 34.3941 21.8184 34.3941 19.8044C34.3941 18.8598 34.1155 18.0594 33.5687 17.4287C32.9053 16.6295 31.955 16.1895 30.8934 16.1895H29.6279C29.2439 16.1895 28.9317 16.5017 28.9313 16.8857V23.0983C28.9313 23.4628 29.2157 23.768 29.5794 23.7929H29.5798ZM30.3246 22.415V17.5819H30.8938C31.5352 17.5819 32.1057 17.8447 32.5005 18.3218L32.5113 18.3346C32.841 18.7137 33.0012 19.1941 33.0012 19.8039C33.0012 21.1943 32.4914 21.9599 31.2978 22.3602C30.9868 22.3925 30.66 22.4108 30.3246 22.415ZM20.3339 26.8933C20.3339 26.8933 20.2276 26.9996 20.1051 26.9751H20.1047C20.0516 26.9668 20.0026 26.9382 19.9619 26.9016C19.9499 26.8908 19.9355 26.8778 19.9188 26.8628C19.3513 26.3506 16.1468 23.4585 15.4926 22.5502C14.7212 21.4521 14.3376 19.5788 15.3825 18.4807C16.4275 17.3826 18.6807 17.2726 20.1666 18.9216C20.1666 18.9216 21.8729 16.9952 23.9629 17.8771C25.9997 18.7547 25.9424 21.122 24.7343 22.5506C23.3588 24.1424 20.3339 26.8933 20.3339 26.8933Z", fill: "currentColor" })), /* @__PURE__ */ React.createElement("defs", null, /* @__PURE__ */ React.createElement("clipPath", { id: "clip0_61_19938" }, /* @__PURE__ */ React.createElement("rect", { x: 0.5, width: 42, height: 42, rx: 21, fill: "white" }))));
...
const FeaturesBlock = () => {
  return /* @__PURE__ */ jsxs("div", { className: `w-[960px] mobile:w-full grid grid-cols-2 mobile:grid-cols-1 grid-rows-[repeat(4,_172px)] mobile:grid-rows-none p-4 mobile:p-0 rounded-3xl ring-1 mobile:ring-0 ring-zinc-700 mt-[114px] mobile:mt-20 gap-4`, children: [
    /* @__PURE__ */ jsxs("div", { className: `flex flex-col justify-between row-span-2 mobile:row-span-1 px-8 py-6 mobile:px-4 mobile:py-4 bg-zinc-750 overflow-hidden rounded-2xl border border-[#e8e8ed]/[0.08] backdrop-blur-sm shadow-[0px_2px_16px_-6px_theme(colors.zinc-950)] bg-[radial-gradient(49.02%_125.31%_at_11.73%_0%,_rgb(65,_65,_71)_10.000000149011612%,_rgb(55,_55,_61)_100%)] mobile:gap-6`, children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: `flex flex-col gap-3`, children: [
        ...
        /* @__PURE__ */ jsx("span", { className: `typo-sm text-zinc-250`, children: "All necessary items’ positions can be defined by users keeping necessary ones always at hand" })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: `flex flex-col justify-between row-span-2 mobile:row-span-1 px-8 py-6 mobile:px-4 mobile:py-4 bg-zinc-750 overflow-hidden rounded-2xl border border-[#e8e8ed]/[0.08] backdrop-blur-sm shadow-[0px_2px_16px_-6px_theme(colors.zinc-950)] bg-[radial-gradient(49.02%_125.31%_at_11.73%_0%,_rgb(65,_65,_71)_10.000000149011612%,_rgb(55,_55,_61)_100%)] mobile:gap-6`, children: [
      /* @__PURE__ */ jsx(
      ...
      /* @__PURE__ */ jsxs("div", { className: `flex flex-col gap-3`, children: [
        ...
        /* @__PURE__ */ jsx("span", { className: `typo-sm text-zinc-250`, children: "Notes, comments and what not. Remember that onboarding is also collaboration between your team and users " })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: `flex flex-col justify-between row-span-2 mobile:row-span-1 px-8 py-6 mobile:px-4 mobile:py-4 bg-zinc-750 overflow-hidden rounded-2xl border border-[#e8e8ed]/[0.08] backdrop-blur-sm shadow-[0px_2px_16px_-6px_theme(colors.zinc-950)] bg-[radial-gradient(49.02%_125.31%_at_11.73%_0%,_rgb(65,_65,_71)_10.000000149011612%,_rgb(55,_55,_61)_100%)] mobile:gap-6`, children: [
      /* @__PURE__ */ jsx(
...
const Footer = () => {
  return /* @__PURE__ */ jsx("div", { className: `w-full h-[160px] mt-[170px] mobile:mt-14 flex flex-col items-center justify-center`, children: /* @__PURE__ */ jsxs("div", { className: `flex flex-col gap-6 items-center`, children: [
    /* @__PURE__ */ jsx(SvgCanvasLogo, { className: "text-zinc-750  mobile:w-2/3 opacity-50" }),
    /* @__PURE__ */ jsx("span", { className: `text-zinc-750 opacity-90 typo-base font-medium`, children: "© 2024–present" })
  ] }) });
};
...
const Header = () => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex flex-grow", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col flex-grow-0 flex-shrink-0 px-[96px] box-content pt-[256px] w-[960px] mobile:w-full mobile:px-0 mobile:pt-6 gap-[31px] mobile:gap-5", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-row mobile:flex-col self-end w-[384px] mobile:w-full gap-4", children: [
      /* @__PURE__ */ jsxs("a", { href: "https://github.com/jpetroff/canvas-ui-demo", className: "flex flex-row items-center bg-zinc-800 ring-zinc-600 ring-opacity-70 ring-1 box-border rounded-2xl pl-1.5 pr-5 h-8 gap-3 hover:ring-zinc-300 transition-all text-zinc-300 hover:text-zinc-250", children: [
...
const App = () => {
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col w-[1152px] mobile:w-full mobile:px-6 items-center overflow-x-hidden", children: [
    /* @__PURE__ */ jsx(Header, {}),
